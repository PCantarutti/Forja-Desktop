...
import { ArrowRight, ArrowUp, Check, Copy, Edit, FolderOpen, Image, PanelRight, Paperclip, Plus, Refresh, Robo, Search, Sliders, Square, TelaCheia, Trash, Undo, X } from "./icons";
